    ...
    class Handler {
        ...
        public:
            ...
            Handler(Handler const &handler) : g(handler.g), updateStep(handler.updateStep) {
                ...
                rbs.rigidBodies = new Primitives::RigidBody2D*[rbs.capacity];
                ...
                colWrapper.bodies1 = new Primitives::RigidBody2D*[colWrapper.capacity];
                colWrapper.bodies2 = new Primitives::RigidBody2D*[colWrapper.capacity];
